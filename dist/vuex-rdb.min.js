var VuexRdb = (function (t, e) {
  ...
  function P(t, e, n, r, i) {
    ...
    if (null == t) h = null;
      ...
      (h = q(t, d)), n.set(t, h), r.has(d) || r.set(d, m()), r.get(d)[h] || (r.get(d)[h] = {});
      var v = r.get(d)[h],
        y = [];
      try {
        for (var _ = f(Object.entries(t)), w = _.next(); !w.done; w = _.next()) {
          var g = l(w.value, 2),
            b = g[0],
            A = g[1];
      ...
      try {
        for (var x = f(y), T = x.next(); !T.done; T = x.next()) {
          var k = l(T.value, 2);
          E((b = k[0]), (A = k[1]));
        }
      } catch (t) {
      ...
      (e.prototype._init = function (e, n, r) {
        return (
          Object.defineProperties(this, {
            _context: { value: e },
            _key: { value: n },
            _store: { value: T(e)._store },
            _contextSchema: { value: T(e) },
            _schema: { value: T(e)._fields[n].schema },
          }),
    ...
    K = (function () {
      ...
      return (
        ...
        (t.prototype.apply = function (t) {
          ...
          return this.relationship instanceof D
            ? t.filter(function (t) {
      ...
      get: function () {
        if (t._connected) {
          ...
          var r = o.getters[i + '/' + A.GET_RAW](t._id, n),
            a = r[e];
          if (u) {
            var f = { load: null == c ? void 0 : c.getLoad(e) },
              l = s.schema;
            if (s instanceof D)
              return (
                s instanceof N && (a = n.index.get(s, this._id)),
                a ? ((a = l.findByIds(a, f)), f.load && (a = f.load.apply(a)), a && new F()._init(t, e, a)) : void 0
              );
            if (s instanceof S) {
              if (!(null == r ? void 0 : r[s.foreignKey])) return;
              a = r[s.foreignKey];
            }
            return (a = l.find(a, f)), f.load ? f.load.apply(a) : a;
          }
          return r[e];
        }
        return t._caches[H(u)][e];
      },
      set: function (i) {
        t._connected
          ? V(t, e, i, s, n)
          : (function (t, e, n, i) {
              if (i) {
                var o = i.schema;
                (n = J(n, o)), i instanceof D && null != n && (n = Array.isArray(n) ? n : [n].filter(d));
              }
              r.default.set(t._caches[H(!!i)], e, n);
            })(t, e, i, s);
      },
    });
  }
    ...
    function t(t, e) {
      ...
      Object.keys(u).forEach(function (t) {
        ...
        this._connected ||
          ((o = this),
          void 0 === (a = t || {}) && (a = {}),
          Object.entries(T(o)._fields).forEach(function (t) {
            var e,
              n = l(t, 2),
              r = n[0],
              i = n[1];
            o._caches[H(i instanceof O)][r] = null !== (e = a[r]) && void 0 !== e ? e : i.default;
          }),
                ...
                if (c in n._fields) {
                  ...
                  if (d instanceof O) {
                    ...
                    if (null == h) e[c] = null;
                      ...
                      var v = [];
                      try {
                        for (var y = f(h), m = y.next(); !m.done; m = y.next()) {
                          var _ = m.value;
      ...
      (t.prototype.$addRelated = function (t, e) {
        return s(this, void 0, void 0, function () {
          ...
          return c(this, function (r) {
            return [
              2,
              (n = T(this))._store.dispatch(n._namespace + '/' + b.ADD_RELATED, {
                id: this._id,
                related: t,
                data: e,
                schema: n,
      ...
      (t.prototype.$removeRelated = function (t, e) {
        return s(this, void 0, void 0, function () {
          ...
          return c(this, function (r) {
            return [
              2,
              (n = T(this))._store.dispatch(n._namespace + '/' + b.REMOVE_RELATED, {
                id: this._id,
                related: t,
                relatedId: e,
                schema: n,
      ...
      return (
        ...
        (t.prototype.registerWatcher = function () {
          ...
          this.unwatch = this.store.watch(
              ...
              var r,
                ...
                u = e.reduce(function (t, e) {
                  var n = l(e, 2),
                    r = n[0],
                    i = n[1];
                  return (t[r] = { foreignKey: i, data: m() }), t;
                }, m()),
              ...
              try {
                for (var c = f(s), h = c.next(); !h.done; h = c.next()) {
                  var d = l(h.value, 2),
                    ...
                    v = d[1];
                  try {
                    for (var y = ((o = void 0), f(e)), _ = y.next(); !_.done; _ = y.next()) {
                      var w = l(_.value, 2),
                        g = w[0],
                        b = w[1];
                      null != v[b] && (u[g].data[v[b]] || (u[g].data[v[b]] = []), u[g].data[v[b]].push(p));
                    }
                  } catch (t) {
                    o = { error: t };
                  } finally {
            ...
            function (e) {
              t.store.commit(t.namespace + '/' + g.SET_INDEX, {
                indexName: t.name,
      ...
      return (
        ...
        (t.prototype.toObject = function () {
          var t,
            ...
            i = m();
          try {
            for (var o = f(this.map), a = o.next(); !a.done; a = o.next()) {
              var u = l(a.value, 2),
                s = u[0],
                c = u[1];
              i[s.entityName] = m();
              try {
                for (var h = ((n = void 0), f(c.interests)), d = h.next(); !d.done; d = h.next()) {
                  var p = d.value;
        ...
        (t.prototype.init = function () {
          var t, e;
          try {
            for (var n = f(this.map.values()), r = n.next(); !r.done; r = n.next()) {
