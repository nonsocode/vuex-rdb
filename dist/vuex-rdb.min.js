var VuexRdb = (function (t, e) {
  ...
  function N(t, e, n, r, i) {
    ...
    var y,
      _ = (function (t) {
        return Array.isArray(t) ? t[0] : t.prototype instanceof Q ? t : t instanceof O ? t.schema : null;
      })(e),
      w = _._fields;
    if (null == t) y = null;
    else if (
      Array.isArray(t) &&
      (function (t) {
        return Array.isArray(t) || t instanceof D;
      })(e)
    )
      y = t
        .map(function (t) {
          return N(t, _, n, r, i + 1).result;
        })
        .filter(function (t) {
          return null != t;
        });
      ...
      (y = z(t, _)), n.set(t, y), r.has(_) || r.set(_, m()), r.get(_)[y] || (r.get(_)[y] = {});
      var g = r.get(_)[y],
        b = [],
        A = [],
        E = [];
      try {
        for (var x = l(Object.entries(t)), P = x.next(); !P.done; P = x.next()) {
          var T = f(P.value, 2),
            R = T[0],
            L = T[1];
          R in w && (w[R] instanceof O ? b : A).push([R, L]);
        }
      } catch (t) {
        o = { error: t };
      } finally {
      ...
      try {
        for (var F = l(b), M = F.next(); !M.done; M = F.next()) {
          var B = f(M.value, 2),
            $ = ((R = B[0]), N((L = B[1]), (q = w[R]), n, r, i + 1).result);
          E.push({ key: R, value: $, relationship: q });
        }
      } catch (t) {
        u = { error: t };
      } finally {
      ...
      try {
        for (var C = l(A), W = C.next(); !W.done; W = C.next()) {
          var G = f(W.value, 2);
          (R = G[0]), (L = G[1]);
          g[R] = L;
        }
      ...
      try {
        for (var U = l(E), X = U.next(); !X.done; X = U.next()) {
          var q,
            Y = X.value;
          K((R = Y.key), (L = Y.value), (q = Y.relationship));
        }
      } catch (t) {
        d = { error: t };
      } finally {
    ...
    return (
      ...
      (e.prototype._init = function (e, n, r) {
        return (
          Object.defineProperties(this, {
            _context: { value: e },
            _key: { value: n },
            _store: { value: P(e)._store },
            _contextSchema: { value: P(e) },
            _schema: { value: P(e)._fields[n].schema },
          }),
      ...
      (e.prototype.toPlainArray = function () {
        return h(this).map(function (t) {
          return t instanceof Q ? t.$toObject() : t;
        });
      }),
      ...
      u([L()], e.prototype, 'push', null),
      u([L()], e.prototype, 'unshift', null),
      u(
        [
          function (t, e, n) {
            var r = n.value;
    ...
    var n,
      ...
      o = function (t) {
        ...
        '*' === e
          ...
          : n._fields[e] && n._fields[e] instanceof O
          ? $(e, n._fields[e], t, i)
          ...
          return (
            Object.entries(r).forEach(function (e) {
              ...
              r.split('.')
                ...
                .forEach(function (t) {
                  var e;
                  p(i) && ((null !== (e = t.query) && void 0 !== e) || (t.query = new W(t)), i.call(null, t.query));
                });
            }),
            this
          );
  ...
  (U.define = function (t, e, n) {
    ...
    (X.define = function (t, e, n) {
      return new j(t, e, n);
    });
  var q = ['data', 'relationship'],
    Y = function (t) {
      return q[t ? 1 : 0];
    },
    H = function (t, e) {
  ...
  function J(t, e, n, r, i) {
    ...
    if (r) {
      ...
      if (
        ((n = H(n, f)),
        r instanceof D && null != n && (n = Array.isArray(n) ? n : [n].filter(d)),
        null != n &&
          !(function (t, e) {
            var n = e.schema;
    ...
    Object.defineProperty(t, e, {
      ...
      get: function () {
        if (t._connected) {
          ...
          var r = o.getters[i + '/' + A.GET_RAW](t._id, n),
            a = r[e];
          if (u) {
            ...
            if (s instanceof D)
              return (
                s instanceof j && (a = n.index.get(s, this._id)),
                a ? ((a = f.findByIds(a, l)), l.load && (a = l.load.apply(a)), a && new F()._init(t, e, a)) : void 0
              );
            if (s instanceof S) {
      ...
      set: function (i) {
        t._connected
          ...
          : (function (t, e, n, i) {
              if (i) {
                var o = i.schema;
                (n = H(n, o)), i instanceof D && null != n && (n = Array.isArray(n) ? n : [n].filter(d));
              }
              r.default.set(t._caches[Y(!!i)], e, n);
            })(t, e, i, s);
      },
    });
  }
    ...
    function t(t, e) {
      ...
      Object.keys(u).forEach(function (t) {
        ...
        this._connected ||
          ((o = this),
          void 0 === (a = t || {}) && (a = {}),
          Object.entries(P(o)._fields).forEach(function (t) {
            var e,
              n = f(t, 2),
              r = n[0],
              i = n[1];
            o._caches[Y(i instanceof O)][r] = null !== (e = a[r]) && void 0 !== e ? e : i.default;
          }),
              ...
              Object.entries(e).reduce(function (e, o) {
                ...
                if (c in n._fields) {
                  ...
                  if (d instanceof O) {
                    var p = d.schema;
                    if (null == h) e[c] = null;
                    else if (Array.isArray(h) && d instanceof D) {
                      var v = [];
                      try {
      ...
      (t.prototype.$addRelated = function (t, e) {
        return s(this, void 0, void 0, function () {
          ...
          return c(this, function (r) {
            return [
              2,
              (n = P(this))._store.dispatch(n._namespace + '/' + b.ADD_RELATED, {
                id: this._id,
                related: t,
                data: e,
                schema: n,
      ...
      (t.prototype.$removeRelated = function (t, e) {
        return s(this, void 0, void 0, function () {
          ...
          return c(this, function (r) {
            return [
              2,
              (n = P(this))._store.dispatch(n._namespace + '/' + b.REMOVE_RELATED, {
                id: this._id,
                related: t,
                relatedId: e,
                schema: n,
  ...
  function Z(t, e, n) {
    ...
    return {
      ...
      actions:
        ...
        (o[b.ADD_RELATED] = function (t, e) {
          var n,
            ...
            s = e.data,
            c = e.schema;
          if (!(u in c._fields && c._fields[u] instanceof O)) throw new Error('Unknown Relationship: [' + u + ']');
          var l = i[A.FIND](o, c);
          if (!l) throw new Error("The item doesn't exist");
          var f = c._fields[u];
          if (f instanceof D) {
            ...
            })((s = l[u] || []).concat(v), function (t) {
              return z(t, f.schema);
            });
          }
          return r(b.UPDATE, { id: o, data: ((n = {}), (n[u] = s), n), schema: c });
        }),
        (o[b.REMOVE_RELATED] = function (t, e) {
          var n,
            r = t.dispatch,
            i = t.getters,
            o = e.id,
            ...
            u = e.relatedId,
            s = e.schema;
          if (!(a in s._fields && s._fields[a] instanceof O)) throw new Error('Unknown Relationship: [' + a + ']');
          var c = Array.isArray(o) ? o : [o],
            l = i[A.FIND_BY_IDS](c, s);
          if (0 !== l.length) {
            var f = s._fields[a],
              h = f.schema;
            if (f instanceof D) {
        ...
        (o[b.UPDATE] = function (t, e) {
          ...
          var s,
            ...
            l = n[A.FIND_BY_IDS](c, u).filter(d);
      ...
      getters:
        ...
        (u[A.ALL] = function (t, e) {
          return function (n, r) {
            return void 0 === r && (r = {}), e[A.FIND_BY_IDS](Object.keys(t.data[n.entityName]), n, r);
          };
        }),
        u),
    };
  ...
  function et(t) {
    return (
      ...
      function (e, n) {
        var r = e.constructor;
        null == r._fields && (r._fields = m()), n in r._fields || (r._fields[n] = et.define(t));
      }
    );
  }
  function nt(t) {
    ...
    ot = (function () {
      ...
      return (
        (t.prototype.addIndex = function (t) {
          ...
          this.map.has(n)
            ? (e = this.map.get(n))
            : ((e = new it(n, this.store, this.namespace, n.entityName)), this.map.set(n, e)),
            e.addRelationship(t);
        }),
        ...
        (t.prototype.get = function (t, e) {
          var n = t.schema,
            r = t.parentSchema;
          return this.store.getters[this.namespace + '/' + A.GET_INDEX](n, r.entityName, e);
        }),
        t
      );
    })(),
    at = { schemas: [], namespace: 'database' };
  return (
    (t.BelongsTo = U),
    (t.Field = et),
    (t.HasMany = X),
    ...
    (t.generateDatabasePlugin = function (t) {
      ...
      return function (t) {
        var e = new ot(t, r);
        Object.defineProperty(Q, 'index', { value: e }),
          n.forEach(function (n) {
            !(function (t, e, n) {
              t._fields || Object.defineProperty(t, '_fields', { value: m({}) }),
                'string' != typeof t.id || t.id in t._fields || (t._fields[t.id] = new x()),
              ...
              Object.values(n._fields).forEach(function (t) {
                t instanceof j && e.addIndex(t);
              });
          }),
          t.registerModule(r, Z(t, n, e)),
          e.init();
      };
    }),
    t
