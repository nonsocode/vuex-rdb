var VuexRdb = (function (t, e) {
  ...
  var N = (function (t) {
      ...
      return (
        ...
        (e.prototype.withoutRelationships = function () {
      ...
      return (
        ...
        (e.prototype.withoutRelationships = function () {
          ...
          return (
            ...
            t.prototype.withoutRelationships.call(this)
          );
        }),
        ...
        (e.prototype.get = function () {
          ...
          return (
            ...
            this.initLoad()
              ? e.map(function (e) {
                  return t.schema.find(z(e, t.schema), { load: t.load });
                })
              : e
          );
        }),
        (e.prototype.first = function () {
          ...
          if (e) return this.initLoad() ? this.schema.find(z(e, this.schema), { load: this.load }) : e;
        }),
        e
      );
    })(N),
  ...
  var C = (function () {
      function t(t, e) {
        ...
        Object.defineProperties(this, {
          ...
          _id: { value: o, enumerable: !1, configurable: !1, writable: !0 },
        });
        var a = q(this)._fields;
        try {
          for (var u = l(Object.keys(a)), s = u.next(); !s.done; s = u.next()) {
            U(this, s.value);
          }
        } catch (t) {
          n = { error: t };
      ...
      return (
        ...
        (t.$list = function (t) {
          var e = this;
          return it.define(t, function () {
            return e;
          });
        }),
        (t.$field = function (t) {
          return void 0 === t && (t = {}), nt.define(t);
        }),
  ...
  function $(t, e, n, r, i) {
    ...
    if (null == t) _ = null;
      ...
      _ = t
        .map(function (t) {
          return $(t, w, n, r, i + 1).result;
        })
        .filter(function (t) {
          return null != t;
        });
    else if (n.has(t)) _ = n.get(t);
    else {
      (_ = z(t, w)), n.set(t, _), r.has(w) || r.set(w, m()), r.get(w)[_] || (r.get(w)[_] = {});
      var b = r.get(w)[_],
        x = [],
        A = [],
        O = [];
      try {
        for (var E = l(Object.entries(t)), S = E.next(); !S.done; S = E.next()) {
          var j = f(S.value, 2),
            k = j[0],
            N = j[1];
          k in g && (g[k] instanceof D ? x : A).push([k, N]);
        }
      } catch (t) {
        o = { error: t };
      } finally {
      ...
      try {
        for (var P = l(x), R = P.next(); !R.done; R = P.next()) {
          var F = f(R.value, 2),
            B = ((k = F[0]), $((N = F[1]), (J = g[k]), n, r, i + 1).result);
          O.push({ key: k, value: B, relationship: J });
        }
      } catch (t) {
        u = { error: t };
      } finally {
      ...
      try {
        ...
        try {
          K && !K.done && (h = G.return) && h.call(G);
        } finally {
          if (c) throw c.error;
        }
      }
      try {
        for (var q = l(O), H = q.next(); !H.done; H = q.next()) {
          var J,
            Y = H.value;
          (k = Y.key), (N = Y.value);
          switch (!0) {
            case (J = Y.relationship) instanceof T:
            case J instanceof W:
              b[k] = N;
              break;
            case J instanceof M:
              ...
              var V = J,
                ...
                Q = V.foreignKey;
              try {
                for (var Z = ((v = void 0), l(N)), tt = Z.next(); !tt.done; tt = Z.next()) {
                  var et = tt.value;
                  r.get(U)[et][Q] = _;
                }
              } catch (t) {
                ...
                try {
                  tt && !tt.done && (y = Z.return) && y.call(Z);
                } finally {
                  if (v) throw v.error;
                }
              }
      ...
      get: function () {
        if (t._connected) {
          ...
          if (u) {
            ...
            if (s instanceof I)
              return (
                s instanceof M && (a = n.index.get(s, this._id)),
                a ? ((a = f.findByIds(a, l)), l.load && (a = l.load.apply(a)), a && new X()._init(t, e, a)) : void 0
              );
            if (s instanceof L) {
              if (!(null == r ? void 0 : r[s.foreignKey])) return;
              a = r[s.foreignKey];
            }
            return (a = f.find(a, l)), l.load ? l.load.apply(a) : a;
          }
          return r[e];
        }
  ...
  function nt(t) {
    return (
      ...
      function (e, n) {
        var r = e.constructor;
        null == r._fields && (r._fields = m()), n in r._fields || (r._fields[n] = nt.define(t));
      }
    );
  }
  function rt(t) {
    return function (e, n) {
      ...
      null == r._fields && (r._fields = m()),
        n in r._fields ||
          (r._fields[n] = rt.define(t, function () {
            return r;
          }));
    };
  }
  function it(t) {
    return function (e, n, r) {
      ...
      null == i._fields && (i._fields = m()),
        n in i._fields ||
          (i._fields[n] = it.define(t, function () {
            return i;
          }));
    };
  }
  (window.modelCache = et),
    (nt.define = function (t) {
      return void 0 === t && (t = {}), new O(t);
    }),
    (rt.define = function (t, e) {
      return new T(t, e);
    }),
    (it.define = function (t, e) {
      return new W(t);
    });
  var ot = (function () {
      function t(t, e, n, r) {
    ...
    at = (function () {
      ...
      return (
        (t.prototype.addIndex = function (t) {
          ...
          this.map.has(n)
            ? (e = this.map.get(n))
            : ((e = new ot(n, this.store, this.namespace, n.entityName)), this.map.set(n, e)),
            e.addRelationship(t);
        }),
