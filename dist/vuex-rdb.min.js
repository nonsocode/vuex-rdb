var VuexRdb = (function (t, e) {
  ...
  function N(t, e, n, r, i) {
    ...
    if (null == t) h = null;
      ...
      (h = z(t, d)), n.set(t, h), r.has(d) || r.set(d, m()), r.get(d)[h] || (r.get(d)[h] = {});
      var v = r.get(d)[h],
        y = [];
      try {
        for (var _ = l(Object.entries(t)), w = _.next(); !w.done; w = _.next()) {
          var g = f(w.value, 2),
            b = g[0],
            A = g[1];
          b in p && (p[b] instanceof O ? y.push([b, A]) : (v[b] = A));
        }
      } catch (t) {
        o = { error: t };
      } finally {
      ...
      try {
        for (var x = l(y), P = x.next(); !P.done; P = x.next()) {
          var T = f(P.value, 2);
          E((b = T[0]), (A = T[1]));
        }
      } catch (t) {
      ...
      get: function () {
        if (t._connected) {
          ...
          if (u) {
            ...
            if (s instanceof D)
              return (
                s instanceof k && (a = n.index.get(s, this._id)),
