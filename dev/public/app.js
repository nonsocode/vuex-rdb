...
var __vue_render__ = function() {
  ...
  return _c("div", [_vm._v("Yall playing")])
};
...
var normalize$1$1 = function normalize(input, schema) {
...
var identity$1 = function (k) { return k; };
...
var unique = function () {
    ...
    return __spread(new Set(items.flat()));
};
var enumerator = function (target) { return unique(cacheNames.map(function (name) { return Object.keys(target[name]); })); };
...
var Model = /** @class */ (function () {
    ...
    Object.defineProperty(Model.prototype, "helper", {
        get: function () {
            return "Yes";
        },
        enumerable: false,
    ...
    return {
        ...
        actions: (_b = {},
            _b[Actions.ADD] = function (ctx, item) {
                var _a = normalize$1$1(item, entitySchema), entities = _a.entities, result = _a.result;
            ...
            _b[Actions.ADD_RELATED] = function (_a, _b) {
                ...
                if (isList(relationshipDef)) {
                    var items = (Array.isArray(data) ? data : [data]).filter(identity$1);
                    data = item[related] || [];
            ...
            _b[Actions.UPDATE] = function (_a, _b) {
                ...
                var ids = Array.isArray(id) ? id : [id];
                var items = getters[Getters.FIND_BY_IDS](ids).filter(identity$1);
        ...
        getters: (_c = {},
            ...
            _c[Getters.FIND_BY_IDS] = function (state, getters) {
                return function (ids, opts) {
                    if (ids === void 0) { ids = []; }
                    if (opts === void 0) { opts = {}; }
                    return ids.map(function (id) { return getters[Getters.FIND](id, opts); }).filter(identity$1);
                };
            },
